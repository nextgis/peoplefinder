...
<link href="${request.static_url('peoplefinder:static/contrib/jtable/themes/metro/pf/jtable.css')}" rel="stylesheet">
<link href="${request.static_url('peoplefinder:static/contrib/select2/css/select2.min.css')}" rel="stylesheet">
