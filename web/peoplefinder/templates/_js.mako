...
<script src="${request.static_url('peoplefinder:static/contrib/select2/js/select2.js')}"></script>
...
<script src="${request.static_url('peoplefinder:static/js/observers/trackingObserver.js')}"></script>
